...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.14 //0.22    // Unit: mm compression per 1mm/s extruder speed
 ...
 */
  ...
  //#define MESH_MIN_Y MESH_INSET //JLD
...
#define TEMP_PROBE_PIN                          15  // Analog Input
